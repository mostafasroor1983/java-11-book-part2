...
public class Main {
  public static void main(String[] args) {
    ...
    /*Comparator<Squirrel> comparator1 = Comparator.comparing(Squirrel::getSpecies)
      .thenComparingInt(Squirrel::getWeight);*/

    // sorting based on Comparable
    //Comparator<Squirrel> comparator1 = Comparator.naturalOrder();

    // sorting based on reversed Comparable
    Comparator<Squirrel> comparator1 = Comparator.reverseOrder();
